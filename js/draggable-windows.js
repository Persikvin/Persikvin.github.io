// Функции для перетаскивания окон и анимации цифр

// Тёмно-зелёная палитра цветов для цифр
const colors = [
    '#003300', // очень тёмный зелёный
    '#004400', // тёмный зелёный
    '#005500', // средне-тёмный зелёный
    '#006600', // зелёный
    '#002200', // почти чёрный зелёный
    '#001100'  // чёрно-зелёный
];

// Храним активные цифры для анимации
const activeDigits = [];
...
function makeDraggable(element) {
    ...
    function drag(e) {
        if (!isDragging) {
            // Уменьшенный спавн цифр - создаём только 1 цифру при движении
            if (Math.random() < 0.3) { // 30% шанс создать цифру
